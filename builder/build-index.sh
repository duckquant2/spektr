...
<p class="lead">Журнал для вдумчивых родителей детей с РАС. Раз в месяц — о науке, новостях, доказательных методах помощи и живых историях. Каждое утверждение сопровождается ссылкой на источник.</p>
<hr>
</header>
