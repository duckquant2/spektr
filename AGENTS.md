...
- Файла `.nojekyll` в `dist/` нет и не нужно: при деплое через Actions Jekyll не
  запускается, а `upload-pages-artifact` начиная с v4 всё равно не кладёт dotfiles в артефакт.
